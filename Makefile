...
# translation
SOURCES = polygonsplitter.py ui_polygonsplitter.py __init__.py polygonsplitterdialog.py
#TRANSLATIONS = i18n/polygonsplitter_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = polygonsplitter

PY_FILES = polygonsplitter.py polygonsplitterdialog.py __init__.py

EXTRAS = polygon_splitter.png 

UI_FILES = ui_polygonsplitter.py
